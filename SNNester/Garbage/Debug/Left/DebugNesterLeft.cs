...
namespace Core.Shared
{
    ...
    {
        public static void Debug_NesterLeft(SGSymbol symbol_LEFT, SGSymbol symbol_RIGHT, SGDelimiter delimiter_LEFT, SGDelimiter delimiter_RIGHT, SGText text_STATIC, SGText text_DYNAMIC, Boolean debug)
        {
            goto descriptor;
            ...
            descriptor:
            {
                if (debug is true)
                {
                    var message = String.Join('\n'.ToString(), new String[] {
                        String.Empty + nameof(SNNester) + ' ' + "::" + ' ' + nameof(Debug_NesterLeft) + ' ' + '{',
